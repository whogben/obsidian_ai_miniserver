...
A complete Obsidian tool in ~320 tokens! ([see tool_prompt.md](tool_prompt.md))
...
- The entire tool schema uses ~320 tokens thanks to minimized docstrings, zero duplication or boilerplate — see [tool_prompt.md](tool_prompt.md)
