...
- list_files(path="", extensions=[".md"] "Empty matches all.", max_depth=1 "-1 for unlimited.", offset=0, limit=100 "-1 for unlimited results.", sort_by="name" [name|length|modified], sort_order="asc" [asc|desc]): Folder tree. Folders end with /. Returns: `<path> | <modified_at> | <size unit>`
